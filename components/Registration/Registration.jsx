...
const Registration = ({ onSwitchToLogin, onRegistrationSuccess }) => {
    ...
    const validateForm = () => {
        ...
        // Validazione ruolo (mappato sul campo ruolo_utente lato backend)
        if (!formData.ruolo) {
            newErrors.ruolo = 'Seleziona un ruolo';
        } else if (formData.ruolo !== 'Dipendente' && formData.ruolo !== 'Organizzatore') {
    ...
    return (
        <div className="registration-container">
            <div className="registration-card">
                <h2 className="registration-title">Registrazione utente</h2>
                <p className="registration-subtitle">Crea un account per accedere alla gestione eventi di formazione</p>
